...
const IntroCard = ({ title, paragraph, image }: Props) => {
    return (
        <Link to={`/${title}`}>
            <article className="rounded-2xl border-2 col-span-1 p-5 md:block flex flex-col items-center transform transition duration-500 hover:scale-105 hover:bg-primary hover:text-white">
                ...
                <p className="md:mt-6 mt-2 text-left  line-clamp-3">
                    {paragraph}
                </p>
            </article>
        </Link>
