    ...
    <div className="drawer-side  z-30 border-r  ">
      ...
      <ul className="menu  pt-2 w-80 bg-base-100 min-h-full  text-base-content">
        ...
        <div className="flex flex-1 flex-col justify-between ">
          ...
          <div>
            <div className="flex justify-start items-center px-4 py-2 gap-x-2  mb-6 gap-6">
              <div className="icon">
                <span dangerouslySetInnerHTML={{ __html: Icon('facebook') }} />
              </div>
              <div className="icon">
                <span dangerouslySetInnerHTML={{ __html: Icon('x') }} />
              </div>
              <div className="icon">
                <span dangerouslySetInnerHTML={{ __html: Icon('linkedin') }} />
              </div>
            </div>
            <button onClick={logoutUser} className="flex justify-start items-center px-4 py-2 gap-x-2 hover:bg-gray-200">
