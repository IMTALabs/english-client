      ...
      <TitleCard title="" topMargin="mt-4">
        <div className="max-w-sm w-full lg:max-w-full flex last:mb-0 items-center justify-between">
          ...
          <div className="dropdown dropdown-hover">
            ...
            <ul tabIndex={0} className="dropdown-content z-[1] menu p-4 shadow bg-base-100 rounded-box w-56 !-translate-x-48 space-y-1">
              <li> Listening -1</li>
              <li> Reading (Your article): -1</li>
              <li> Reading ( Generate Article): -2</li>
              <li> Writing -2</li>
            </ul>
          </div>
