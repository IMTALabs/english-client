...
import NotificationBodyRightDrawer from 'src/features/common/components/notification-body-right-drawer';
import {closeRightDrawer} from 'src/features/common/right-drawer-slice';
import {RIGHT_DRAWER_TYPES} from 'src/utils/global-constants';
function RightSidebar() {
  const {isOpen, header, bodyType, extraObject} = useAppSelector(
